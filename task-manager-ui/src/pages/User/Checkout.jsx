      ...
      {showQRModal && (
        <div className="qr-modal-overlay">
          <div className="qr-modal-content text-center p-4 shadow-lg rounded">
            <h4 className="fw-bold mb-3" style={{ color: "#d81b60" }}>
            ...
            <div className="d-flex justify-content-center gap-3">
              ...
              >
                <i className="bi bi-check-circle-fill me-2"></i>Tôi đã thanh
                toán
              </button>
            </div>
          </div>
      ...
      <div className="row">
        <div className="col-lg-7 mb-4">
          <div className="checkout-card p-4 shadow-sm">
            <h4 className="mb-4 fw-bold checkout-heading">
            ...
            <form onSubmit={handlePlaceOrder}>
              ...
              <h4 className="mb-3 fw-bold checkout-heading">
              ...
              <button
                type="submit"
                className="btn btn-danger btn-lg w-100 rounded-pill py-3 fw-bold btn-place-order"
              >
                HOÀN TẤT ĐẶT HÀNG
              </button>
            </form>
        ...
        <div className="col-lg-5">
          <div className="checkout-card p-4 shadow-sm order-summary-card">
            ...
            <div className="order-items mb-3">
              {cartItems.length > 0 ? (
                cartItems.map((item, index) => {
                  const itemName =
                    item.name || item.TenSP || item.ten_sp || "Sản phẩm";
                  const itemPrice = Number(
                    item.price || item.Gia || item.gia || 0
                  );
                  const itemQty = Number(
                    item.quantity || item.SoLuong || item.so_luong || 1
                  );
                  const itemImg =
                    item.image || item.HinhAnh || item.hinh_anh || "";
                  let imageSrc = "https://placehold.co/60x60";
                  if (itemImg) {
                    imageSrc =
                      itemImg.startsWith("data:image") ||
            ...
            <div className="d-flex justify-content-between align-items-center pt-3 border-top">
              ...
              <span className="fw-bold fs-3" style={{ color: "#d81b60" }}>
            ...
            <div className="text-center mt-4">
              <Link
                to="/products"
                className="text-decoration-none back-to-shop"
              >
                ← Quay lại cửa hàng
              </Link>
            </div>
